 ...
 */
public class LocatorUtil implements LocationListener {
    ...
    private LocatorUtil.Method method;
    private LocatorUtil.Listener callback;
    public LocatorUtil(Context context) {
        super();
        this.context = context;
        this.locationManager = (LocationManager) context.getSystemService(Context.LOCATION_SERVICE);
    }

    public void getLocation(LocatorUtil.Method method, LocatorUtil.Listener callback) {
        this.method = method;
    ...
    private void requestUpdates(String provider) {
        if (this.locationManager.isProviderEnabled(provider)) {
            if (provider.contentEquals(LocationManager.NETWORK_PROVIDER)
                    && ConnectivityUtil.isConnected(this.context)) {
                ...
                this.locationManager.requestLocationUpdates(provider, TIME_INTERVAL, DISTANCE_INTERVAL, this);
                    ...
                    && ConnectivityUtil.isConnectedMobile(this.context)) {
    ...
    public void onProviderDisabled(String provider) {
        ...
        if (this.method == LocatorUtil.Method.NETWORK_THEN_GPS
